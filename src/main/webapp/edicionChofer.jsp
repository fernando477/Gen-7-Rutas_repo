...
<nav class="navbar navbar-inverse">
   <div class="container-fluid">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <h2>listado Formulario Alta chofer</h2>
            </div>
...
<input type="text" name="licencia" id="licencia" class="form-control" value="<%=chofer.getLicencias() != null?  chofer.getLicencias() : "" %>">                        <% if (errores != null && errores.containsKey("apLicencia")){ %>
...
<input type="text" name="telefono" id="telefono" class="form-control" value="<%=chofer.getTelefono() != null?  chofer.getTelefono() : "" %>">                        <% if (errores != null && errores.containsKey("telefono")){ %>
...
<input type="text" name="fechaNacimiento" id="fechaNacimiento" class="form-control" value="<%= fecha %>">
                    ...
                    <div class="form_group">
                        ...
                        <input type="checkbox" name="disponibilidad" id="disponibilidad" class="form-checj-input" value="1" <%=disponible%>>

                    </div>

                    <div class="form_group">
                        <button href="" type="submit" class="btn btn-success">Guardar</button>
                    </div>
                </div>
            </form>
        </div>
